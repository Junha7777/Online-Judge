...
medial_index = (char_code % (21 * 28)) // 28
final_index = char_code % 28

print(initials[initial_index])
print(medials[medial_index])
if finals[final_index] != '':
    print(finals[final_index])